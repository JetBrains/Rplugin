...
<info descr="R_FUNCTION_CALL">source</info>("<info descr="Open file in editor (ACTION_GOTO_DECLARATION)">R/A.R</info>")
<info descr="R_FUNCTION_CALL">source</info>("<info descr="Open file in editor (ACTION_GOTO_DECLARATION)">/home/user/R/B.R</info>")

# Tooltip for named file argument
<info descr="R_FUNCTION_CALL">source</info>(<info descr="R_NAMED_ARGUMENT">file</info> = "<info descr="Open file in editor (ACTION_GOTO_DECLARATION)">R/A.R</info>")
