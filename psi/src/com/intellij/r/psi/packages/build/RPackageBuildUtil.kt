...
package com.intellij.r.psi.packages.build
...
import com.intellij.r.psi.packages.build.RPackageBuildUtil.isPackage

object RPackageBuildUtil {
  private val KEY = Key.create<Unit>("com.intellij.r.psi.packages.build.RPackageBuildUtil")
