...
import com.intellij.r.psi.RElementGenerator
import com.intellij.r.psi.parsing.RElementTypes.R_EQ
import com.intellij.r.psi.parsing.RElementTypes.R_IDENTIFIER
import com.intellij.r.psi.parsing.RElementTypes.R_IN
import com.intellij.r.psi.parsing.RElementTypes.R_LEFT_ASSIGN
import com.intellij.r.psi.parsing.RElementTypes.R_LEFT_COMPLEX_ASSIGN
import com.intellij.r.psi.parsing.RElementTypes.R_RBRACKET
import com.intellij.r.psi.parsing.RElementTypes.R_RIGHT_ASSIGN
import com.intellij.r.psi.parsing.RElementTypes.R_RIGHT_COMPLEX_ASSIGN
...
import com.intellij.r.psi.psi.isNamespaceAccess
import com.intellij.r.psi.psi.references.RImportReference
import com.intellij.r.psi.psi.references.RNamespaceReference
import com.intellij.r.psi.psi.references.ROperatorReference
import com.intellij.r.psi.psi.references.RReferenceBase
import com.intellij.r.psi.psi.references.RReferenceImpl
...
internal object RPsiImplUtil {
  ...
  fun getDocStringValue(functionExpression: RFunctionExpression): String? {
    ...
    val blockExpression = PsiTreeUtil.findChildOfType(functionExpression, com.intellij.r.psi.psi.api.RBlockExpression::class.java) ?: return null
  ...
  private fun renameIdentifier(name: String, expression: RIdentifierExpression, oldNameIdentifier: ASTNode) {
    ...
    val realName = if (text.startsWith('`') && text.endsWith('`'))
      "`$name`"
    else
      rNamesValidator.quoteIfNeeded(name, project)
    val dummyFile = RElementGenerator.createDummyFile(realName, false, project)
