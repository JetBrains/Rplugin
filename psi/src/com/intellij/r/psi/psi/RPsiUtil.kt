...
import com.intellij.r.psi.parsing.RElementTypes.R_AND
import com.intellij.r.psi.parsing.RElementTypes.R_ANDAND
import com.intellij.r.psi.parsing.RElementTypes.R_AT
import com.intellij.r.psi.parsing.RElementTypes.R_BREAK
import com.intellij.r.psi.parsing.RElementTypes.R_COLON
import com.intellij.r.psi.parsing.RElementTypes.R_DIV
import com.intellij.r.psi.parsing.RElementTypes.R_ELSE
import com.intellij.r.psi.parsing.RElementTypes.R_EQEQ
import com.intellij.r.psi.parsing.RElementTypes.R_EXP
import com.intellij.r.psi.parsing.RElementTypes.R_FOR
import com.intellij.r.psi.parsing.RElementTypes.R_FORWARD_PIPE_OPERATOR
import com.intellij.r.psi.parsing.RElementTypes.R_FUNCTION
import com.intellij.r.psi.parsing.RElementTypes.R_GE
import com.intellij.r.psi.parsing.RElementTypes.R_GT
import com.intellij.r.psi.parsing.RElementTypes.R_HELP
import com.intellij.r.psi.parsing.RElementTypes.R_IF
import com.intellij.r.psi.parsing.RElementTypes.R_IN
import com.intellij.r.psi.parsing.RElementTypes.R_INFIX_OP
import com.intellij.r.psi.parsing.RElementTypes.R_LE
import com.intellij.r.psi.parsing.RElementTypes.R_LEFT_ASSIGN
import com.intellij.r.psi.parsing.RElementTypes.R_LIST_SUBSET
import com.intellij.r.psi.parsing.RElementTypes.R_LT
import com.intellij.r.psi.parsing.RElementTypes.R_MINUS
import com.intellij.r.psi.parsing.RElementTypes.R_MULT
import com.intellij.r.psi.parsing.RElementTypes.R_NEXT
import com.intellij.r.psi.parsing.RElementTypes.R_NOT
import com.intellij.r.psi.parsing.RElementTypes.R_OR
import com.intellij.r.psi.parsing.RElementTypes.R_OROR
import com.intellij.r.psi.parsing.RElementTypes.R_PLUS
import com.intellij.r.psi.parsing.RElementTypes.R_REPEAT
import com.intellij.r.psi.parsing.RElementTypes.R_RIGHT_ASSIGN
import com.intellij.r.psi.parsing.RElementTypes.R_TILDE
import com.intellij.r.psi.parsing.RElementTypes.R_WHILE
import com.intellij.r.psi.psi.api.RAssignmentStatement
import com.intellij.r.psi.psi.api.RAtOperator
...
import com.intellij.r.psi.psi.api.RForwardPipeOperator
...
import com.intellij.r.psi.psi.api.RRepeatStatement
import com.intellij.r.psi.psi.api.RSubscriptionExpression
import com.intellij.r.psi.psi.api.RWhileStatement
...
fun RCallExpression.isFunctionFromLibrary(functionName: String, packageName: String): Boolean {
  ...
  return targets != null && targets.any {
    ...
    RSkeletonUtilPsi.skeletonFileToRPackage(it.containingFile)?.name == packageName
  }
}