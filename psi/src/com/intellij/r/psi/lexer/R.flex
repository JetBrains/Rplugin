...
/* Use 'ant' command in src/com/intellij/r/psi/lexer directory to regenerate the lexer */
...
import static com.intellij.r.psi.parsing.RTokenTypes.*;
import static com.intellij.r.psi.parsing.RParserDefinition.*;
