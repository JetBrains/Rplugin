...
/**
 * RcppEigen — the R package which can use for creating a new package
 */
class RRcppEigenPanel(rProjectSettings: RProjectSettings) : RRcppPackageManagerPanel(rProjectSettings) {
  ...
  override val panelName: String
    get() = "R package using RcppEigen panel"
