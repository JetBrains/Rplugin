...
/**
 * Passed to [RNotebookCellLines.IntervalListener] when the document is changed.
 *
 ...
 */
data class RNotebookCellLinesEvent(
  val documentEvent: DocumentEvent,
  val oldIntervals: List<RNotebookCellLines.Interval>,
  val oldAffectedIntervals: List<RNotebookCellLines.Interval>,
  val newIntervals: List<RNotebookCellLines.Interval>,
  val newAffectedIntervals: List<RNotebookCellLines.Interval>,
