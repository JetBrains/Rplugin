...
/**
 * was moved from [com.intellij.notebooks.visualization.r.inlays.ClipboardUtils]
 */
object RClipboardUtils {
  ...
  private fun copyPngImageToClipboard(image: BufferedImage) {
