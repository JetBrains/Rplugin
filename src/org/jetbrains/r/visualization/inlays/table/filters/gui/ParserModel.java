...
import org.jetbrains.r.visualization.inlays.table.filters.parser.Parser;
...
public class ParserModel implements IParserModel {
  ...
  static final class StringTypeFormat extends TypeFormat {
  ...
  static final class BooleanTypeFormat extends TypeFormat {
  ...
  static final class IntegerTypeFormat extends TypeFormat {
  ...
  static final class LongTypeFormat extends TypeFormat {
  ...
  static final class ShortTypeFormat extends TypeFormat {
  ...
  static final class FloatTypeFormat extends TypeFormat {
  ...
  static final class DoubleTypeFormat extends TypeFormat {
  ...
  static final class ByteTypeFormat extends TypeFormat {
  ...
  static final class CharacterTypeFormat extends TypeFormat {
  ...
  /** Factory to build character objects. */
  static final class EnumTypeFormat extends TypeFormat {
    private static final long serialVersionUID = -7238741018044298862L;
