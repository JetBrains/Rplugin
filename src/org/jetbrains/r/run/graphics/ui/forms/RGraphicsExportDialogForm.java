...
public class RGraphicsExportDialogForm extends JDialog {
  ...
  private final JCheckBox openAfterSavingCheckBox;
  private final JPanel directoryFieldPanel;
  private final JPanel widthInputPanel;
  private final JPanel keepAspectRatioButtonPanel;
  private final JPanel heightInputPanel;
  private final JPanel resolutionInputPanel;
  private final JPanel southPanel;
  private final JPanel okCancelButtonsPanel;
  private final JPanel graphicsContentPanel;
  private final JPanel refreshButtonPanel;
  ...
  public RGraphicsExportDialogForm() {
    {
      ...
      contentPane.setLayout(new GridLayoutManager(5, 1, new Insets(8, 12, 8, 12), -1, -1));
      ...
      gbc.weighty = 1.0;
      gbc.anchor = GridBagConstraints.WEST;
      gbc.insets = new Insets(0, 28, 0, 8);
      ...
      this.$$$loadLabelText$$$(label5,
                               this.$$$getMessageFromBundle$$$("messages/RPluginBundle", "graphics.panel.settings.dialog.resolution"));
      gbc = new GridBagConstraints();
      gbc.gridx = 5;
      gbc.gridy = 0;
      gbc.anchor = GridBagConstraints.WEST;
      ...
      panel5.setLayout(new GridLayoutManager(1, 1, new Insets(8, 0, 8, 0), -1, -1));
      ...
      contentPane.add(spacer2, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1,
                                                   GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(-1, 8), null, 0, false));
    }
