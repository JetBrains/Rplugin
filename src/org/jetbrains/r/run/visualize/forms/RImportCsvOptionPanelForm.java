  ...
  public RImportCsvOptionPanelForm() {
    {
      ...
      this.$$$loadLabelText$$$(label1, this.$$$getMessageFromBundle$$$("messages/RPluginBundle", "import.data.dialog.form.skip"));
      ...
      this.$$$loadButtonText$$$(trimSpacesCheckBox,
                                this.$$$getMessageFromBundle$$$("messages/RPluginBundle", "import.data.dialog.form.trim.spaces"));
      ...
      this.$$$loadLabelText$$$(label3, this.$$$getMessageFromBundle$$$("messages/RPluginBundle", "import.data.dialog.form.quotes"));
      contentPane.add(label3, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
                                                  GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0,
                                                  false));
      final JLabel label4 = new JLabel();
      this.$$$loadLabelText$$$(label4, this.$$$getMessageFromBundle$$$("messages/RPluginBundle", "import.data.dialog.form.escape"));
