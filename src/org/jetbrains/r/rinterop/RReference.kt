...
open class RReference internal constructor(internal val proto: RRef, internal val rInterop: RInterop) {
...
class RPersistentRef internal constructor(index: Int, rInterop: RInterop, disposableParent: Disposable? = null):
  ...
  override fun dispose() {
    ...
    rInterop.executeAsync(rInterop.asyncStub::disposePersistentRefs, PersistentRefList.newBuilder().addIndices(proto.persistentIndex).build())
  }
}
