...
package org.intellij.datavis.inlays.table.filters.gui;

import javax.swing.table.TableColumn;

/**
 * <p>A ITableFilterHeaderObserver instance receives notifications when the
 * associated {@link org.intellij.datavis.inlays.table.filters.gui.IFilterEditor} instances are
...
public interface IFilterHeaderObserver {
     ...
     * org.intellij.datavis.inlays.table.filters.gui.IFilterEditor} when the filter's content is
     * updated</p>
     *
     * @param  header       the associated table filter header
